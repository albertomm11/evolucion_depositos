...
deposits_over_assets <- full_join(customer_deposits_over_assets, household_deposits_over_assets, by="fecha")


#Exportar a XLSX----

write_xlsx(list(deposits_over_assets=deposits_over_assets),#primero nombre de la hoja luego = df
                path = "customer_deposits_over_assets.xlsx")
